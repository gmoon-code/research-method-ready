...
## 3. Future GitHub Pages publication

When you deliberately decide to publish:

1. Create or use the intended **public** GitHub repository.
2. Upload the repository contents to the `main` branch root.
3. Keep real credentials out of GitHub, commits, issues, screenshots, and files.
4. In GitHub, open **Settings → Pages**.
5. Under **Build and deployment**, select **Deploy from a branch**.
6. Select `main` and `/ (root)`.
7. Save and verify the published site on desktop and mobile.

GitHub Pages supports publishing directly from a branch/root for a static site. The repository includes `.nojekyll` and does not require a build step.
