...
def static_release_checks()->None:
    required=[
        ...
        'docs/OFFLINE_RELEASE_VERIFICATION_v2.15.0.md','docs/PUBLIC_GITHUB_READINESS_v2.15.0.md','docs/PUBLIC_GITHUB_PUBLICATION_AUDIT_v2.15.0.md','SECURITY.md',
        'scripts/verify-public-github-readiness-v2.15.0.py'
    ]
...
def main()->int:
    ...
    run('Research Chat FREE backend/adapter/Worker/deployment contracts',['npm','run','test:research-chat'])
