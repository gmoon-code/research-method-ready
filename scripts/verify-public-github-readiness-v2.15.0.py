...
CURRENT_PUBLIC_DOCS=['README.md','START_HERE.md','SECURITY.md','docs/PUBLIC_GITHUB_READINESS_v2.15.0.md']
ARCHIVED_PAID_DOCS=[
...
def ensure_public_structure()->None:
    required=[
        '.nojekyll','.gitignore','.env.example','index.html','404.html','README.md','START_HERE.md','SECURITY.md',
        ...
        'docs/PUBLIC_GITHUB_READINESS_v2.15.0.md','docs/archive/README.md',
    ]
...
def ensure_current_docs_are_current()->None:
    ...
    for marker in ['Cloudflare Workers Free','assets/runtime-config.js','RMS_CHAT_ACCESS_CODE','docs/archive/']:
